...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-View%20App-blue?style=flat-square&logo=github)](https://isaacjace116.github.io/invoice-generator-pro-/)
...
### Live App
Visit the live app here: **[https://isaacjace116.github.io/invoice-generator-pro-/](https://isaacjace116.github.io/invoice-generator-pro-/)**

### Local Development
Since this is a pure client-side app, you can run it locally by simply opening `index.html` in any modern browser:

```bash
git clone https://github.com/IsaacJace116/invoice-generator-pro-.git
...
- **Email/Password:** Local storage-based auth with bcrypt-like hashing
...
*Invoice Generator Pro — Create professional invoices in seconds.*
